...
const Carousel = () => {
  ...
  return (
    <div className="h-[60vh] w-[200vh] mt-10 grid place-items-center mx-auto max-w-xl rounded-md">
        ...
        {images.map((pic, idx) => (
          ...
          >
            <Image
              ...
              width={400}
              height={400}
              className="w-full h-[50vh] object-cover rounded-l hover:shadow-2xl hover:cursor-pointer"
            />
          </div>
        ))}
